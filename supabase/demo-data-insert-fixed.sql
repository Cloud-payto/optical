-- ============================================================
-- OptiProfit Demo Data Insert Script (FIXED)
-- ============================================================
-- This script inserts all demo data using the existing demo user
--
-- Demo User ID: 3251cae7-ee61-4c5f-be4c-4312c17ef4fd
-- Demo User Email: demo@optiprofit.com
--
-- Tables populated:
-- 1. vendors (Modern Optical)
-- 2. emails (Order #6817 email with parsed_data)
-- 3. orders (Order #6817)
-- 4. inventory (18 frames from the order)
--
-- Usage:
...
-- ============================================================
-- 1. Insert Demo Vendor (Modern Optical)
-- ============================================================
...
-- ============================================================
-- 2. Insert Demo Email (Order #6817)
-- ============================================================
INSERT INTO public.emails (
  ...
  '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', -- Demo user UUID
  'f1d2aaf8-1877-4579-9ed0-083541dae7e7',
...
Total Pieces: 18',
  ...
  '{
    "items": [
      ...
      {"sku": "MODERN_PLASTICS_II-ESTIMATE-BLACK_GREY_CRY", "upc": "675254321814", "size": "54", "brand": "MODERN PLASTICS II", "color": "BLACK/GREY CRY", "model": "ESTIMATE", "gender": "unisex", "status": "pending", "vendor": "Modern Optical", "material": "PLASTIC", "quantity": 1, "in_stock": true, "frame_id": "MODERN PLASTICS II-ESTIMATE", "api_verified": true, "order_number": "6817", "color_normalized": "Black/Grey", "confidence_score": 70, "validation_reason": "Vendor catalog match"},
      {"sku": "MODERN_PLASTICS_II-FICTION-BLACK_CRYST_GRY", "upc": "675254303308", "size": "53", "brand": "MODERN PLASTICS II", "color": "BLACK/CRYST GRY", "model": "FICTION", "gender": "unisex", "status": "pending", "vendor": "Modern Optical", "material": "Plastic", "quantity": 1, "in_stock": true, "frame_id": "MODERN PLASTICS II-FICTION", "api_verified": true, "order_number": "6817", "color_normalized": "Black/Crystal", "confidence_score": 70, "validation_reason": "Vendor catalog match"},
      {"sku": "MODERN_PLASTICS_II-GRADIENT-NAVY_CRYST_BRN", "upc": "675254314342", "size": "52", "brand": "MODERN PLASTICS II", "color": "NAVY CRYST/BRN", "model": "GRADIENT", "gender": "female", "status": "pending", "vendor": "Modern Optical", "material": "Plastic", "quantity": 1, "in_stock": true, "frame_id": "MODERN PLASTICS II-GRADIENT", "api_verified": true, "order_number": "6817", "color_normalized": "Navy/Brown", "confidence_score": 70, "validation_reason": "Vendor catalog match"},
      {"sku": "MODERN_PLASTICS_II-PATRICK-BLACK", "upc": "675254314656", "size": "55", "brand": "MODERN PLASTICS II", "color": "BLACK", "model": "PATRICK", "gender": "male", "status": "pending", "vendor": "Modern Optical", "material": "Plastic", "quantity": 1, "in_stock": true, "frame_id": "MODERN PLASTICS II-PATRICK", "api_verified": true, "order_number": "6817", "color_normalized": "Black", "confidence_score": 100, "validation_reason": "Vendor catalog match"},
      {"sku": "MODERN_PLASTICS_II-PATRICK-CRYSTAL", "upc": "675254314663", "size": "55", "brand": "MODERN PLASTICS II", "color": "CRYSTAL", "model": "PATRICK", "gender": "male", "status": "pending", "vendor": "Modern Optical", "material": "Plastic", "quantity": 1, "in_stock": true, "frame_id": "MODERN PLASTICS II-PATRICK", "api_verified": true, "order_number": "6817", "color_normalized": "Crystal", "confidence_score": 100, "validation_reason": "Vendor catalog match"}
    ]
  }'::jsonb,
  NULL,
  false,
...
-- ============================================================
-- 3. Insert Demo Order (Order #6817)
-- ============================================================
...
-- ============================================================
-- 4. Insert Demo Inventory (18 Frames)
-- ============================================================

INSERT INTO public.inventory (id, account_id, vendor_id, order_id, email_id, sku, brand, model, color, size, quantity, status, upc, enriched_data, created_at, updated_at) VALUES
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_AIR-BLACK', 'B.M.E.C.', 'BIG AIR', 'BLACK', '54', 1, 'pending', '675254228656', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_BEAT-BLACK_BROWN', 'B.M.E.C.', 'BIG BEAT', 'BLACK/BROWN', '60', 1, 'pending', '675254179613', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_BOLT-NAVY_FADE', 'B.M.E.C.', 'BIG BOLT', 'NAVY FADE', '58', 1, 'pending', '675254222883', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_DUDE-RUST_BROWN', 'B.M.E.C.', 'BIG DUDE', 'RUST/BROWN', '57', 1, 'pending', '675254231328', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_FLOW-NAVY_GUN_NAVY', 'B.M.E.C.', 'BIG FLOW', 'NAVY/GUN/NAVY', '58', 1, 'pending', '675254299588', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_FRONT-AQUA_BROWN_DEMI', 'B.M.E.C.', 'BIG FRONT', 'AQUA/BROWN DEMI', '57', 1, 'pending', '675254304657', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'B.M.E.C.-BIG_RIVER-GREY_GUNMETAL', 'B.M.E.C.', 'BIG RIVER', 'GREY/GUNMETAL', '55', 1, 'pending', '675254305487', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'GB+_COLLECTION-BEAUTIFUL-BLACK_GOLD', 'GB+ COLLECTION', 'BEAUTIFUL', 'BLACK/GOLD', '56', 1, 'pending', '675254228748', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'GB+_COLLECTION-DETERMINED-TEAL_PINK', 'GB+ COLLECTION', 'DETERMINED', 'TEAL/PINK', '58', 1, 'pending', '675254243062', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'GB+_COLLECTION-WONDROUS-PINK_CRYST_PK', 'GB+ COLLECTION', 'WONDROUS', 'PINK CRYST/PK', '54', 1, 'pending', '675254313710', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-CLEO-CLEO_BLACK_CRY', 'MODERN PLASTICS II', 'CLEO', 'CLEO BLACK CRY', '52', 1, 'pending', '675254300505', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-CONGENIAL-BLUE_PINK_CRYST', 'MODERN PLASTICS II', 'CONGENIAL', 'BLUE/PINK CRYST', '54', 1, 'pending', '675254314236', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-ESTIMATE-BLACK_BURG_CRY', 'MODERN PLASTICS II', 'ESTIMATE', 'BLACK/BURG CRY', '54', 1, 'pending', '675254321807', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-ESTIMATE-BLACK_GREY_CRY', 'MODERN PLASTICS II', 'ESTIMATE', 'BLACK/GREY CRY', '54', 1, 'pending', '675254321814', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-FICTION-BLACK_CRYST_GRY', 'MODERN PLASTICS II', 'FICTION', 'BLACK/CRYST GRY', '53', 1, 'pending', '675254303308', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-GRADIENT-NAVY_CRYST_BRN', 'MODERN PLASTICS II', 'GRADIENT', 'NAVY CRYST/BRN', '52', 1, 'pending', '675254314342', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-PATRICK-BLACK', 'MODERN PLASTICS II', 'PATRICK', 'BLACK', '55', 1, 'pending', '675254314656', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW()),
(gen_random_uuid(), '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', 'f1d2aaf8-1877-4579-9ed0-083541dae7e7', '50fa0961-9d44-4190-95ce-b57be229ba62', NULL, 'MODERN_PLASTICS_II-PATRICK-CRYSTAL', 'MODERN PLASTICS II', 'PATRICK', 'CRYSTAL', '55', 1, 'pending', '675254314663', '{"order": {"vendor": "Modern Optical", "rep_name": "Payton Millet", "order_date": "9/5/2025", "order_number": "6817", "parse_status": "parsed", "total_pieces": 18, "customer_name": "MARANA EYE CARE", "account_number": "93277"}, "order_number": "6817"}'::jsonb, NOW(), NOW());
...
SELECT 'Demo User' as check_name, COUNT(*) as count FROM auth.users WHERE id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd'
UNION ALL
SELECT 'Vendor', COUNT(*) FROM vendors WHERE id = 'f1d2aaf8-1877-4579-9ed0-083541dae7e7'
UNION ALL
SELECT 'Email', COUNT(*) FROM emails WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd'
UNION ALL
SELECT 'Order', COUNT(*) FROM orders WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd'
UNION ALL
SELECT 'Inventory', COUNT(*) FROM inventory WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd';
