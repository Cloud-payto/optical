-- ============================================================
-- Step 2: Insert Complete Demo Data (FIXED VERSION)
-- ============================================================
...
INSERT INTO public.emails (
  ...
  'From: Amro Habib <amrohabib@yahoo.com>
...
Total Pieces: 18',
  '<html><body><h2>Order Confirmation #6817</h2><p>Thank you for your order!</p></body></html>',
  0,
  0.00,
  'ham',
  'parsed',
...
INSERT INTO public.inventory (
  ...
  (gen_random_uuid(), v_demo_account_id, v_vendor_id, v_order_id, NULL,
   ...
   jsonb_build_object('order_number', '6817', 'demo', true), NOW() - INTERVAL '2 hours', NOW()),
...
RAISE NOTICE 'Demo User Email: demo@optiprofit.com';
RAISE NOTICE '';
...
SELECT 'Vendor Check' as check_type, name, is_active::text
FROM public.vendors
