-- ============================================================
-- OptiProfit Demo Data Insert Script - FINAL VERSION
-- ============================================================
...
-- ============================================================
-- CLEANUP: Remove existing demo data if present
-- ============================================================
...
-- Note: We keep the vendor as it may be used by other accounts
-- Note: We keep the auth.users record as it's the shared demo account
...
INSERT INTO public.emails (
  ...
  '3251cae7-ee61-4c5f-be4c-4312c17ef4fd', -- Demo user ID
...
-- ============================================================
-- VERIFICATION: Check Demo Data Loaded Correctly
-- ============================================================
SELECT
  'Demo data verification' as status,
  (SELECT COUNT(*) FROM public.orders WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd') as orders_count,
  (SELECT COUNT(*) FROM public.inventory WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd') as inventory_count,
  (SELECT COUNT(*) FROM public.emails WHERE account_id = '3251cae7-ee61-4c5f-be4c-4312c17ef4fd') as emails_count;
