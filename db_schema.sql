...
CREATE TABLE public.inventory (
  ...
  status character varying DEFAULT 'pending'::character varying CHECK (status::text = ANY (ARRAY['pending'::character varying, 'confirmed'::character varying, 'in_stock'::character varying, 'sold'::character varying, 'returned'::character varying]::text[])),
